import OneBookDetail from "../components/oneBookDetail/oneBookDetail";
  ...
  return (
    <div className="page__detail">
      ...
      <>
        {book.id && (
        <>
          <SomeBookHeading section_title = {book.book_title} />
          <OneBookDetail {...book} />
              ...
              {user && (
                <div className = "page-detail__admin-buttons container">
                  ...
                  <button onClick = {handleEdit} className= "page-detail__detete-post button-primary">
                    Edit this Book
                  </button>
                </div>
              )}
